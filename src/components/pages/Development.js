  ...
  return (
   <div className='development'>
      <div style={{display:'block'}}>
        <h2>Job Oriented Program - Development</h2>
        <br/>
        <ul>
         <strong>Below Apps are under development, and they are responsive, can be accessed from all the Devices</strong>
          <ul>
        ...
        <br/>
        <ul>
         <strong> Android Mobile Apps - These are under development, deployment, testing ...etc </strong>
          <ul>
