  ...
  return (
   <div className='design'>
      <div style={{display:'block'}}>
        <h2>Job Oriented Program - Designing</h2>
        <br/>
        <ul>
         <strong>Below Apps are completed designing and are currently under development, and they are responsive, can be accessed from all the Devices</strong>
          <ul>
        ...
        <br/>
        <ul>
         <strong> Android Mobile Apps - These are completed designing and are currently under development, deployment, testing ...etc </strong>
          <ul>
